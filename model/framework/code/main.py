...
if __name__ == '__main__':
    ...
    args = Namespace(batch_size=32, checkpoint_dir=model_path+'/checkpoints/finetune/sider', checkpoint_path=None, checkpoint_paths=[model_path+'/checkpoints/finetune/sider/fold_0/model_0/model.pt', model_path+'/checkpoints/finetune/sider/fold_2/model_0/model.pt', model_path+'/checkpoints/finetune/sider/fold_1/model_0/model.pt'], cuda=False, data_path=csv_path, ensemble_size=3, features_generator=None, features_path=[features_path], fingerprint=False, gpu=0, no_cache=True, no_features_scaling=True, output_path=output_path, parser_name='predict')
